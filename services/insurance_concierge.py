...
SYSTEM_PROMPT = "You are a professional insurance policy document auditor. Be precise about coverage details, exclusions, and claim requirements. Return valid JSON only."
...
class InsuranceConcierge:
    ...
    def analyze_coverage(self, policy_text: str, treatment: str) -> Dict:
        ...
        if not self.groq_client:
            return {"status": "fallback", "coverage": "Unknown", "message": "AI Policy Auditor offline. Check your policy document for 'Exclusions' and 'Benefits'."}
